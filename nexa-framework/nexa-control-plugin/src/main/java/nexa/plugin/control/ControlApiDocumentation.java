...
final class ControlApiDocumentation {
        ...
        @OpenApi(path = "/api/connection/enable", methods = HttpMethod.POST, summary = "Enable a connection", operationId = "enableConnection", tags = {
                        "Connection" }, queryParams = @OpenApiParam(name = "connectionId", required = true, description = "Source node identifier"), responses = @OpenApiResponse(status = "200", description = "Connection enabled"))
        ...
        @OpenApi(path = "/api/connection/disable", methods = HttpMethod.POST, summary = "Disable a connection", operationId = "disableConnection", tags = {
                        "Connection" }, queryParams = @OpenApiParam(name = "connectionId", required = true, description = "Source node identifier"), responses = @OpenApiResponse(status = "200", description = "Connection disabled"))
        ...
        @OpenApi(path = "/api/connection/inject", methods = HttpMethod.POST, summary = "Inject a runtime message into a connection", operationId = "injectMessage", tags = {
                        "Connection" }, queryParams = @OpenApiParam(name = "source", required = true, description = "Source node identifier"), requestBody = @OpenApiRequestBody(content = @OpenApiContent(from = RuntimeMessage.class), required = true), responses = @OpenApiResponse(status = "200", description = "Message injected"))
        static void injectMessage() {
        }

        // UNUSED!
        // @OpenApi(path = "/api/connection/add", methods = HttpMethod.POST,
        // summary = "Add a connection", operationId = "addConnection", tags =
        // {"Connection"},
        // queryParams = {
        // @OpenApiParam(name = "source", required = true, description = "Source node
        // identifier"),
        // @OpenApiParam(name = "target", required = true, description = "Target node
        // identifier")
        // },
        // responses = @OpenApiResponse(status = "200", description = "Connection
        // added"))
        // static void addConnection() {}
        // UNUSED!
        // @OpenApi(path = "/api/connection/remove", methods = HttpMethod.POST,
        // summary = "Remove a connection", operationId = "removeConnection", tags =
        // {"Connection"},
        // queryParams = {
        // @OpenApiParam(name = "source", required = true, description = "Source node
        // identifier"),
