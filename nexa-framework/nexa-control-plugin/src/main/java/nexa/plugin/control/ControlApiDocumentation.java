...
final class ControlApiDocumentation {
    ...
    @OpenApi(path = "/api/connection/enable", methods = HttpMethod.POST, summary = "Enable a connection", operationId = "enableConnection", tags = {
            "Connection" }, queryParams = @OpenApiParam(name = "connectionId", required = true, description = "Connection identifier"), responses = @OpenApiResponse(status = "200", description = "Connection enabled", content = @OpenApiContent(from = nexa.framework.runtime.api.control.model.ConnectionInfo.class)))
    ...
    @OpenApi(path = "/api/connection/disable", methods = HttpMethod.POST, summary = "Disable a connection", operationId = "disableConnection", tags = {
            "Connection" }, queryParams = @OpenApiParam(name = "connectionId", required = true, description = "Connection identifier"), responses = @OpenApiResponse(status = "200", description = "Connection disabled", content = @OpenApiContent(from = nexa.framework.runtime.api.control.model.ConnectionInfo.class)))
    static void disableConnection() {
    }

    @OpenApi(path = "/api/connection/{connectionId}", methods = HttpMethod.GET, summary = "Get connection information", operationId = "getConnectionInfo", tags = {
            "Connection" }, pathParams = @OpenApiParam(name = "connectionId", required = true, description = "Connection identifier"), responses = {
                    @OpenApiResponse(status = "200", description = "Connection information", content = @OpenApiContent(from = nexa.framework.runtime.api.control.model.ConnectionInfo.class)),
                    @OpenApiResponse(status = "404", description = "Connection not found")
            })
    ...
    @OpenApi(path = "/api/connection/inject", methods = HttpMethod.POST, summary = "Inject a runtime message into a connection", operationId = "injectMessage", tags = {
            "Connection" }, queryParams = @OpenApiParam(name = "connectionId", required = true, description = "Connection identifier"), requestBody = @OpenApiRequestBody(content = @OpenApiContent(from = RuntimeMessage.class), required = true), responses = @OpenApiResponse(status = "200", description = "Message injected"))
